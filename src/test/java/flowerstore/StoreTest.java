...
class StoreTest {
    ...
    void search() {
        ...
        assertTrue(store.search(flowerx));
        assertTrue(store.search(packx));
        assertTrue(store.search(bucketx));

        assertFalse(store.search(flowery));
        assertFalse(store.search(packy));
        assertFalse(store.search(buckety));
    }
}